function FixedOrder
    ...
    for chunkidx = 1:NumChunks_Odor
        ...
        RewardDelays_Odor = [RewardDelays_Odor  repmat([0 1 2 5.5],1,8)];
    end
    TrialTypes_Odor = TrialTypes_Odor(1:S.NumOdorTrials);
    RewardDelays_Odor = RewardDelays_Odor(1:S.NumOdorTrials);
